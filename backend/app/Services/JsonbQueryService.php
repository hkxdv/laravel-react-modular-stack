...
class JsonbQueryService
{
     ...
     *
     * @param  \Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder  $query  La consulta base a modificar
     ...
     */
    protected function buildJsonPath(string $column, string $path): string
    {
        if (empty($path)) {
            return $column;
        }
     ...
     */
    protected function formatJsonValue(mixed $value): string
    {
        if (is_array($value)) {
