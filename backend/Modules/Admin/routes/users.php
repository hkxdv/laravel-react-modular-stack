...
Route::prefix('users')->name('users.')->group(function () {
    ...
    Route::get('/{user}/edit', [EditController::class, 'show'])->name('edit');
    // Actualiza el usuario existente.
    Route::put('/{user}', [EditController::class, 'update'])->name('update');
    // Elimina el usuario.
    Route::delete('/{user}', [EditController::class, 'destroy'])->name('destroy');
});
