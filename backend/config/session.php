...
return [
    ...
    */
    ...
    | by the HTTP protocol and not by JavaScript. This option can help to
    | mitigate the risk of XSS attacks, but it is not a silver bullet.
    |
    */
    ...
    */
    ...
    | Laravel 13 defaults to 'json'; pinning to 'php' ensures existing sessions
    | remain valid after the upgrade.
    |
    */
