...
return [
    ...
    | reset "broker" that will be used by your application. You may change
    | these values as required, but they're a perfect start for most applications.
    |
    */
    ...
    */
    ...
    'passwords' => [
        ...
        'staff' => [
            ...
            'expire' => 15, // Tiempo más corto para staff por seguridad
            'throttle' => 300, // 5 minutos de throttle
    ...
    |--------------------------------------------------------------------------
    |
    | Configuraciones adicionales de seguridad para el sistema dual.
    |
    */

    'security' => [
        'max_login_attempts' => [
            'staff' => env('STAFF_MAX_LOGIN_ATTEMPTS', 3),
        ],
        'lockout_duration' => [
            'staff' => env('STAFF_LOCKOUT_DURATION', 900),
        ],
