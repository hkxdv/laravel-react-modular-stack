...
return [
    ...
    */
    'stubs' => [
        ...
        'replacements' => [
            ...
            'json' => ['LOWER_NAME', 'STUDLY_NAME', 'KEBAB_NAME', 'MODULE_NAMESPACE', 'PROVIDER_NAMESPACE', 'PATH_NAMESPACE'],
            'config/config' => ['STUDLY_NAME', 'LOWER_NAME'],
            'composer' => [
                'LOWER_NAME',
                'STUDLY_NAME',
                'VENDOR',
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'hkxdv'),
        /* 'author' => [
            'name' => env('MODULE_AUTHOR_NAME', ''),
